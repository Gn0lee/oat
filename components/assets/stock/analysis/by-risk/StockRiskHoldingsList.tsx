...
import type { RiskLevel, StockRiskLevelSummary } from "@/types";
...
interface StockRiskHoldingsListProps {
  data: StockRiskLevelSummary[];
  isLoading?: boolean;
}

export function StockRiskHoldingsList({
  data,
  isLoading,
}: StockRiskHoldingsListProps) {
