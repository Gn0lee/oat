...
import type { StockOwnerHoldings } from "@/types";

const MEMBER_COLORS = ["#4F46E5", "#03B26C", "#FF9F00", "#F04452", "#8B95A1"];

interface StockOwnerHoldingsListProps {
  data: StockOwnerHoldings[];
  isLoading?: boolean;
}

export function StockOwnerHoldingsList({
  data,
  isLoading,
}: StockOwnerHoldingsListProps) {
