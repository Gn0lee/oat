...
export type StockOverviewDetail =
...
interface StockOverviewDetailDrawerProps {
  open: boolean;
  detail: StockOverviewDetail | null;
...
export function StockOverviewDetailDrawer({
  open,
  detail,
  onOpenChange,
}: StockOverviewDetailDrawerProps) {
