...
INSERT INTO public.ledger_entries (
  ...
  from_payment_method_id, to_account_id, from_account_id, category_id
) VALUES
('00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000010', '00000000-0000-0000-0000-000000000001', 18500, '점심 식사', 'expense', true, '오늘 공유 지출 상세 확인용', now(), '00000000-0000-0000-0000-000000000201', null, null, (select id from public.categories where household_id = '00000000-0000-0000-0000-000000000010' and type = 'expense' and name = '식비')),
('00000000-0000-0000-0000-000000000302', '00000000-0000-0000-0000-000000000010', '00000000-0000-0000-0000-000000000001', 9900, '개인 구독', 'expense', false, '개인 기록 노출 범위 확인용', now() - interval '2 hours', '00000000-0000-0000-0000-000000000201', null, null, (select id from public.categories where household_id = '00000000-0000-0000-0000-000000000010' and type = 'expense' and name = '구독/정기결제')),
('00000000-0000-0000-0000-000000000303', '00000000-0000-0000-0000-000000000010', '00000000-0000-0000-0000-000000000002', 42000, '장보기', 'expense', true, null, now() - interval '1 day', '00000000-0000-0000-0000-000000000203', null, null, (select id from public.categories where household_id = '00000000-0000-0000-0000-000000000010' and type = 'expense' and name = '식비')),
('00000000-0000-0000-0000-000000000304', '00000000-0000-0000-0000-000000000010', '00000000-0000-0000-0000-000000000001', 3200000, '월급', 'income', true, '수입 상세 확인용', now() - interval '3 days', null, '00000000-0000-0000-0000-000000000101', null, (select id from public.categories where household_id = '00000000-0000-0000-0000-000000000010' and type = 'income' and name = '급여')),
('00000000-0000-0000-0000-000000000305', '00000000-0000-0000-0000-000000000010', '00000000-0000-0000-0000-000000000002', 250000, '부수입 정산', 'income', false, '과거 개인 수입', now() - interval '35 days', null, '00000000-0000-0000-0000-000000000103', null, (select id from public.categories where household_id = '00000000-0000-0000-0000-000000000010' and type = 'income' and name = '부수입')),
('00000000-0000-0000-0000-000000000306', '00000000-0000-0000-0000-000000000010', '00000000-0000-0000-0000-000000000001', 500000, '투자금 이체', 'transfer', true, '계좌 간 이체 검증', now() - interval '5 days', null, '00000000-0000-0000-0000-000000000102', '00000000-0000-0000-0000-000000000101', null),
('00000000-0000-0000-0000-000000000307', '00000000-0000-0000-0000-000000000010', '00000000-0000-0000-0000-000000000001', 50000, '현금 인출', 'transfer', true, null, now() - interval '6 days', null, null, '00000000-0000-0000-0000-000000000101', null),
('00000000-0000-0000-0000-000000000308', '00000000-0000-0000-0000-000000000010', '00000000-0000-0000-0000-000000000002', 15800, '카페', 'expense', true, '일간조회 과거 날짜 상세 진입 확인용', now() - interval '14 days', '00000000-0000-0000-0000-000000000203', null, null, (select id from public.categories where household_id = '00000000-0000-0000-0000-000000000010' and type = 'expense' and name = '여가/문화'));
