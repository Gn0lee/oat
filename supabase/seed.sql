...
VALUES (
  ...
  '00000000-0000-4000-8000-000000000001',
  '00000000-0000-4000-8000-000000000001',
  '{"sub": "00000000-0000-4000-8000-000000000001", "email": "admin@example.com", "email_verified": true}',
  'email',
  now(),
  now(),
  now()
  ...
  '00000000-0000-4000-8000-000000000002',
  '00000000-0000-4000-8000-000000000002',
  '{"sub": "00000000-0000-4000-8000-000000000002", "email": "member@example.com", "email_verified": true}',
  'email',
  now(),
  now(),
  now()
...
VALUES ('00000000-0000-4000-8000-000000000010', '테스트 가구');
...
('00000000-0000-4000-8000-000000000101', '00000000-0000-4000-8000-000000000010', '00000000-0000-4000-8000-000000000001', '관리자 생활비 통장', '국민은행', '1111', 'checking', 'bank', 2450000.00, now(), '개발용 관리자 입출금 계좌'),
('00000000-0000-4000-8000-000000000102', '00000000-0000-4000-8000-000000000010', '00000000-0000-4000-8000-000000000001', '관리자 투자 계좌', '미래에셋', '2222', 'stock', 'investment', 12500000.00, now(), '주식 거래 검증용 계좌'),
('00000000-0000-4000-8000-000000000103', '00000000-0000-4000-8000-000000000010', '00000000-0000-4000-8000-000000000002', '가구원 생활비 통장', '신한은행', '3333', 'checking', 'bank', 1320000.00, now(), '개발용 가구원 입출금 계좌'),
('00000000-0000-4000-8000-000000000104', '00000000-0000-4000-8000-000000000010', '00000000-0000-4000-8000-000000000002', '가구원 투자 계좌', '한국투자', '4444', 'stock', 'investment', 6800000.00, now(), '가구원 주식 거래 검증용 계좌');

-- Payment Methods
INSERT INTO public.payment_methods (
  id, household_id, owner_id, name, type, linked_account_id, issuer, last_four, payment_day, balance, balance_updated_at, memo
) VALUES
('00000000-0000-4000-8000-000000000201', '00000000-0000-4000-8000-000000000010', '00000000-0000-4000-8000-000000000001', '관리자 생활카드', 'credit_card', '00000000-0000-4000-8000-000000000101', '현대카드', '1234', 25, null, null, '공유 지출 검증용 카드'),
('00000000-0000-4000-8000-000000000202', '00000000-0000-4000-8000-000000000010', '00000000-0000-4000-8000-000000000001', '관리자 현금', 'cash', null, null, null, null, 180000.00, now(), '현금/이체 검증용'),
('00000000-0000-4000-8000-000000000203', '00000000-0000-4000-8000-000000000010', '00000000-0000-4000-8000-000000000002', '가구원 생활카드', 'credit_card', '00000000-0000-4000-8000-000000000103', '삼성카드', '5678', 10, null, null, '가구원 지출 검증용 카드');

-- Stock Settings
INSERT INTO public.household_stock_settings (
  household_id, ticker, name, asset_type, market, currency, risk_level
) VALUES
('00000000-0000-4000-8000-000000000010', '005930', '삼성전자', 'equity', 'KR', 'KRW', 'moderate'),
('00000000-0000-4000-8000-000000000010', 'AAPL', 'Apple Inc.', 'equity', 'US', 'USD', 'aggressive'),
('00000000-0000-4000-8000-000000000010', 'MSFT', 'Microsoft Corp.', 'equity', 'US', 'USD', 'aggressive');
...
('00000000-0000-4000-8000-000000000401', '00000000-0000-4000-8000-000000000010', '00000000-0000-4000-8000-000000000001', '005930', 'buy', 10, 75000, '00000000-0000-4000-8000-000000000102', '오늘 매수 상세 확인용', now()),
('00000000-0000-4000-8000-000000000402', '00000000-0000-4000-8000-000000000010', '00000000-0000-4000-8000-000000000001', '005930', 'sell', 2, 76500, '00000000-0000-4000-8000-000000000102', null, now() - interval '1 day'),
('00000000-0000-4000-8000-000000000403', '00000000-0000-4000-8000-000000000010', '00000000-0000-4000-8000-000000000001', 'AAPL', 'buy', 5, 195.1200, '00000000-0000-4000-8000-000000000102', '달러 자산 매수', now() - interval '7 days'),
('00000000-0000-4000-8000-000000000404', '00000000-0000-4000-8000-000000000010', '00000000-0000-4000-8000-000000000001', 'MSFT', 'buy', 3, 430.5000, '00000000-0000-4000-8000-000000000102', '종목 필터 검증', now() - interval '12 days'),
('00000000-0000-4000-8000-000000000405', '00000000-0000-4000-8000-000000000010', '00000000-0000-4000-8000-000000000002', '005930', 'buy', 4, 74800, '00000000-0000-4000-8000-000000000104', '가구원 거래', now() - interval '3 days'),
('00000000-0000-4000-8000-000000000406', '00000000-0000-4000-8000-000000000010', '00000000-0000-4000-8000-000000000002', 'AAPL', 'buy', 2, 188.0000, '00000000-0000-4000-8000-000000000104', null, now() - interval '20 days'),
('00000000-0000-4000-8000-000000000407', '00000000-0000-4000-8000-000000000010', '00000000-0000-4000-8000-000000000002', 'AAPL', 'sell', 1, 201.0000, '00000000-0000-4000-8000-000000000104', '매도 거래 검증', now() - interval '2 days');
