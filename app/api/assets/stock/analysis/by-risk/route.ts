...
import type {
  MarketType,
  RiskLevel,
  StockRiskHoldingItem,
  StockRiskLevelSummary,
} from "@/types";
...
/**
 * GET /api/assets/stock/analysis/by-risk
 * 위험도별 주식 분석 데이터 조회
 */
export async function GET() {
  try {
    ...
    const riskLevelMap = new Map<
      RiskLevel | null,
      { totalValue: number; holdings: StockRiskHoldingItem[] }
    >();
    ...
    const byRiskLevel: StockRiskLevelSummary[] = Array.from(
