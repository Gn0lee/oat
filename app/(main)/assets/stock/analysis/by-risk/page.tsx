...
import { useStockRiskAnalysis } from "@/hooks/use-stock-risk-analysis";
...
export default function StockRiskAnalysisPage() {
  const { data, isLoading, error } = useStockRiskAnalysis();
